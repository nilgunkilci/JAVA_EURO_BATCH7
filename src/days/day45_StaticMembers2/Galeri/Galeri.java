...
public class Galeri {
   ...
   static ArrayList< Araba> arabalar = new ArrayList<>();
    ...
    static {
        ...
        arabalar.add(new Araba("Honda","Acord")); // direk parantez icinde obje olusturulup, ekleme yapilabilir.

        Araba araba1 = new Araba( "Toyota", " Corolla");  // once obje olusturup, sonra ekleme yapilabilir
        arabalar.add(araba1);
        arabalar.add(new Araba("Honda","Acord"));
        ...
        arabalar.add(new Araba("Toyota","Avansis"));
